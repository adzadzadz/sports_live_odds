...
function enqueueAssets()
{
  ...
  wp_enqueue_style( 'sloMainStyles', plugins_url('src/assets/css/styles.css',__FILE__) ,false, '5.1.4', 'all');
  ...
  wp_enqueue_script( 'sloJs', plugins_url('src/assets/js/main.js', __FILE__), ['jquery'], '5.1.4', false);
